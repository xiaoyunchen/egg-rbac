...
class rbac {
  ...
  modifyPermissionDesc(_id, desc) {
    if (!_id) {
      return new Error('[egg-rbac] modifyPermissionAlias parameter _id is undefined');
    }
    if (!desc) {
      return new Error('[egg-rbac] modifyPermissionAlias parameter desc is undefined');
    }
    return this.storage.modifyPermissionDesc(_id, desc);
  }
